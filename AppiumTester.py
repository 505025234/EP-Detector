...
class TestApp():
    ...
    def __init__(self,dri):
        ...
        self.netCon = "imitator" #wlan  data  imitator
        ...
        self.appName = "com.iqilu.app147" # app名字 com.eg.android.AlipayGphone    com.UCMobile
        self.mainActiName = "com.multap.MainActivity" # com.eg.android.AlipayGphone.AlipayLogin   com.uc.browser.InnerUCMobile
        # mainAcitivity的名字
        self.xml = None
        self.mainXml = None
    ...
    def GetTreeAll(self,rootNode, level, cliresult,scrresult,lonresult,allList,fullList):
        ...
        if (cliAble=="true" or scroAble=="true" or lonAble=="true") and (bounds) and (bounds not in allList):
    ...
    def TestAllPages(self): #总的测试函数
        ...
        #     time.sleep(random.uniform(0, i*3))
        ...
        #             print('after eror')
        #             nowPic = None
        #     # nowPic.save(str(i)+".jpg")
        #     tempSimi = self.getHistSimiLari(nowPic,self.mainActiIma)
        #     print(tempSimi)
