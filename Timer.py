...
class TimeRecord():
    ...
    def appOver(self,appname):
        self.appTime = time.clock() - self.appTime
    ...
    def pageStart(self):
        self.pageTimeCount= time.clock()

    def pageOver(self):
        allTime = time.clock() - self.pageTimeCount
    ...
    def conStart(self):
        self.conTimeCount= time.clock()

    def conOver(self):
        allTime = time.clock() - self.conTimeCount
    ...
    def genStart(self):
        self.genTimeCount= time.clock()

    def genOver(self):
        allTime = time.clock() - self.genTimeCount
    ...
    def oraStart(self):
        self.oraTimeCount= time.clock()

    def oraOver(self):
        allTime = time.clock() - self.oraTimeCount
    ...
    def navStart(self):
        self.navTimeCount= time.clock()

    def navOver(self):
        allTime = time.clock() - self.navTimeCount
